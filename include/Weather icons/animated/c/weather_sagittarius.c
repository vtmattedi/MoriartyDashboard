...
#ifndef LV_ATTRIBUTE_IMG_WEATHER_SAGITTARIUS
#define LV_ATTRIBUTE_IMG_WEATHER_SAGITTARIUS
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_WEATHER_SAGITTARIUS uint8_t weather_sagittarius_map[] = {
...
const lv_img_dsc_t weather_sagittarius = {
